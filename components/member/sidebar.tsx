...
import { CheckCircle, Download, Settings, LogOut, Menu, X, MessageSquare, Mail } from "lucide-react"
...
const MemberSidebar = memo(function MemberSidebar() {
  ...
  const menuItems = useMemo(() => [
    { href: "/member", label: "Dashboard", icon: CheckCircle },
    { href: "/member/tasks", label: "My Tasks", icon: CheckCircle },
    { href: "/member/files", label: "My Files", icon: Download },
    { href: "/member/support", label: "Submit Ticket", icon: MessageSquare },
    { href: "/member/tickets", label: "My Tickets", icon: Mail },
    ...
    <>
      ...
      >
        ...
        <div className="mb-8 pt-12 md:pt-0">
          <Link href="/member" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
